...
export default function TelefunkenBrandPage() {
  ...
  const telefunkenModels = tvScreens.filter((item) => item.brand === "Telefunken");
          ...
          {pagedModels.map((model) => (
            ...
            >
              <div className="mb-4 w-32 h-20 flex items-center justify-center">
                <Image src={model.image || "/brands/zero-tv.png"} alt={model.model} width={128} height={80} className="object-contain" />
              </div>
