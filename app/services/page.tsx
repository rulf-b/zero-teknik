...
export const metadata: Metadata = {
  title: 'Hizmetlerimiz | Ekran Sitesi',
  description: 'Ekran Sitesi olarak sunduğumuz LED ekran, dijital tabela, anakart tamiri ve ekran değişimi hizmetlerimizi inceleyin.',
  keywords: 'hizmetler, ekran sitesi, LED ekran, dijital tabela, anakart tamiri, ekran değişimi',
  openGraph: {
    title: 'Hizmetlerimiz | Ekran Sitesi',
    description: 'LED ekran, dijital tabela ve ekran tamiri hizmetlerimizi keşfedin.',
    type: 'website',
    locale: 'tr_TR',
  },
  twitter: {
