...
export default function NordmendeBrandPage() {
  ...
  const nordmendeModels = tvScreens.filter((item) => item.brand === "Nordmende");
          ...
          {pagedModels.map((model) => (
            ...
            >
              <div className="mb-4 w-32 h-20 flex items-center justify-center">
                <Image src={"/brands/zero-tv.png"} alt={model.model} width={128} height={80} className="object-contain" />
              </div>
